...
<div class="notice-frame">
    <a href="http://127.0.0.1:8000/possition">Add Possitions  | </a>
    <a href="http://127.0.0.1:8000/person">View/edit Participants</a>
</div>
<form id="myForm" action="person/create" enctype="multipart/form-data" method="POST"><!--action="sendData.php"-->
  <div class="container">
    {!! csrf_field()!!}
    <div class="section">
        ...
        <div style="border:1px solid #ccc; padding: 10px 0 10px 20px; margin-top: 10px; background-color: #ffffff;">
            <input type="file" placeholder="Enter your NIC Number" name="fileToUpload" > <span class="span">Please note: file size should be below than 2mb</span>
        </div>
    </div>

    <div class="section martop30">
        <!--display only the active possitions-->
